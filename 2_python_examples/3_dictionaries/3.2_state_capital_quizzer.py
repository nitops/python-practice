...
for i in [1, 2, 3, 4, 5]:
    state = random.choice(States)  # to make random choices
    capital = capital_dic[state]
    capital_guess = input("What is capital of   " + state + "\n")  # to get input from user.
    if capital == capital_guess:
        print("Yes! You entered right value,capital of " + state + " is " + capital)
    else:
        print("You entered wrong value capital of " + state + " is " + capital)
